...
public class ManyToManyCustomNamesTest extends Base implements IModel{
    ...
    public void TestSaveWithExistingObject() {
        ...
        String query = "SELECT * FROM g_c WHERE c_id="+c1.getId()+" AND g_id = "+g.getId();
        String query2 = "SELECT * FROM g_c WHERE c_id="+c2.getId()+" AND g_id = "+g.getId();
    ...
    public void TestInitializing(){
        ...
        Field field;
        try {
            field = g.getClass().getDeclaredField("cs");
    ...
    public void TestReplacingCollection(){
        Group g = new Group().find(groupId); 
        List<Category> oldCategory = g.getCs();
        ...
        String query  = "SELECT * FROM g_c WHERE c_id="+newC1.getId()+" AND g_id = "+g.getId();
        String query2 = "SELECT * FROM g_c WHERE c_id="+newC2.getId()+" AND g_id = "+g.getId();
        String query3 = "SELECT * FROM g_c WHERE c_id="+newC3.getId()+" AND g_id = "+g.getId();
        String query4 = "SELECT * FROM g_c WHERE c_id="+oldC1.getId()+" AND g_id = "+g.getId();
        String query5 = "SELECT * FROM g_c WHERE c_id="+oldC2.getId()+" AND g_id = "+g.getId();
        ResultSet rs = Manager.rawSQLfind(query);
        ResultSet rs2 = Manager.rawSQLfind(query2);
