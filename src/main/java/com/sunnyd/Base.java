...
public class Base implements IModel {
    ...
    private void relationHasMany(Field relation, String relationTableName){
        ...
        //Get results
        List<Map<String, Object>> results = Manager.findAll(relationTableName, condition);
        ...
        for (int i = 0; i < size; i++) {
            try {
                collection[i] = relationClass.getConstructor(Map.class).newInstance(results.get(i));
